...
#Estudos #InteligenciaArtificial #AprenderMelhor #Psicologia""",
        "schedule": {"type": "SCHEDULE_FOR_LATER", "scheduledFor": "2026-08-03T15:00:00Z"} # Mon 12:00 BRT
    },
    {
        "num": 1,
        "name": "01_ia_da_dinheiro_mesmo.mp4",
        "caption": """A IA não trouxe clientes automaticamente. Eu ainda preciso divulgar meu trabalho, investir e provar que consigo entregar.

O que mudou foi a velocidade: tarefas que antes poderiam levar dias passaram a levar minutos.
...
#InteligenciaArtificial #TrabalhoComIA #Automacao #Tecnologia""",
        "schedule": {"type": "SCHEDULE_FOR_LATER", "scheduledFor": "2026-08-03T21:00:00Z"} # Mon 18:00 BRT
    },
    {
        "num": 2,
...
#InteligenciaArtificial #Automacao #Tecnologia #Produtividade""",
        "schedule": {"type": "SCHEDULE_FOR_LATER", "scheduledFor": "2026-08-04T15:00:00Z"} # Tue 12:00 BRT
    },
    {
        "num": 4,
...
#CarreiraEmTecnologia #InteligenciaArtificial #Programacao #Automacao""",
        "schedule": {"type": "SCHEDULE_FOR_LATER", "scheduledFor": "2026-08-04T21:00:00Z"} # Tue 18:00 BRT
    },
    {
        "num": 6,
...
#Prospeccao #VendasB2B #MarketingDigital #Empreendedorismo""",
        "schedule": {"type": "SCHEDULE_FOR_LATER", "scheduledFor": "2026-08-05T15:00:00Z"} # Wed 12:00 BRT
    },
    {
        "num": 3,
...
Objetivo, contexto, referências e limites ajudam a reduzir respostas genéricas.
...
#PromptEngineering #InteligenciaArtificial #Automacao #Produtividade""",
        "schedule": {"type": "SCHEDULE_FOR_LATER", "scheduledFor": "2026-08-05T21:00:00Z"} # Wed 18:00 BRT
    },
    {
        "num": 7,
...
#AgentZero #AgentesDeIA #OpenSource #Automacao""",
        "schedule": {"type": "SCHEDULE_FOR_LATER", "scheduledFor": "2026-08-06T15:00:00Z"} # Thu 12:00 BRT
    },
    {
        "num": 8,
...
#ComputerUse #AgentesDeIA #OpenSource #Automacao""",
        "schedule": {"type": "SCHEDULE_FOR_LATER", "scheduledFor": "2026-08-06T21:00:00Z"} # Thu 18:00 BRT
    }
]

print("Starting WoopSocial Automation for 8 New Videos...")
...
for item in posts:
    ...
    print(f"\n==============================================")
    print(f"Processing Video [{item['num']}]: {item['name']}")
    
    if not os.path.exists(v_path):
        print(f"Waiting for video render: {v_path}")
...
print("\n==============================================")
print("FINAL 8 NEW VIDEOS SCHEDULING RESULTS:")
