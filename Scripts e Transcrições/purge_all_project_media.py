...
print("1. Purging ALL stored media items from WoopSocial project to free storage quota...")
...
while True:
    ...
    if r.status_code != 200:
        print(f"Error fetching media list: {r.status_code} {r.text}")
        break
...
print(f"\nPurged total {total_deleted} media files from WoopSocial storage library!")
...
print("\n2. Scheduling all 8 Approved Videos on TikTok @kthyeu...")
