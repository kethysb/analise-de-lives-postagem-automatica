"""
Agenda as 5 Histórias Narrativas no TikTok @kthyeu via WoopSocial
Com caption completo (legenda + hashtags) e slots a partir de 03/08.
"""
import os
import requests
import time
...
videos = [
    {
        ...
        "scheduledFor": "2026-08-03T12:00:00Z",   # Dom 03/08 - 09:00 BRT
...
#Empreendedorismo #TrafegoPago #PrimeirosClientes #MarketingDigital #Freelancer #JornadaEmpreendedora"""
    },
    {
        ...
        "scheduledFor": "2026-08-03T16:00:00Z",   # Dom 03/08 - 13:00 BRT
        "date_brt": "Domingo (03/08) às 13:00 BRT",
...
#Psicologia #InteligenciaArtificial #DesenvolvimentoPessoal #UX #Programacao #JornadaEmpreendedora"""
    },
    {
        ...
        "scheduledFor": "2026-08-03T21:00:00Z",   # Dom 03/08 - 18:00 BRT
...
#AgenciaDigital #Automacao #Empreendedorismo #Marketing #Escalabilidade #JornadaEmpreendedora"""
    },
    {
        ...
        "scheduledFor": "2026-08-04T12:00:00Z",   # Seg 04/08 - 09:00 BRT
        "date_brt": "Segunda (04/08) às 09:00 BRT",
...
#APIs #Programacao #InteligenciaArtificial #DevLife #Automacao #Aprendizado"""
    },
    {
        ...
        "scheduledFor": "2026-08-04T16:00:00Z",   # Seg 04/08 - 13:00 BRT
        "date_brt": "Segunda (04/08) às 13:00 BRT",
...
print("=" * 60)
print("AGENDANDO AS 5 HISTÓRIAS NARRATIVAS NO TIKTOK @kthyeu")
print("=" * 60)
...
print("\n" + "=" * 60)
print(f"FINALIZADO: {success}/5 histórias agendadas com sucesso no TikTok!")
print("=" * 60)
